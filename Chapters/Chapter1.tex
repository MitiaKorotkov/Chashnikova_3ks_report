\section{Справочные сведения}\label{sec:general_information}
	...
	\subsection{Состав группы}\label{subsec:group_composition}
		...
		Поход пройден группой в полном составе. Коротков Дмитрий и Короткова Дарья не участвовали в радиальном выходе на вер. Штулу-Тау (дошли до высоты 3400 м). Коротков Дмитрий, Короткова Дарья, Мокульская Стефания не участвовали в радиальном выходе на пер. Надежда + пер. Кенчат + вер. Кенчатбаши. \fxnote{Описать, кто что не прошёл}.
